...
class BoxZoomHandler {
    ...
    _onMouseMove(e: MouseEvent) {
        ...
        if (!this._box) {
            this._box = DOM.create('div', 'mapcube-boxzoom', this._container);
            this._container.classList.add('mapcube-crosshair');
    ...
    _finish() {
        ...
        this._container.classList.remove('mapcube-crosshair');
